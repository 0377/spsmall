...
(20, '微商宝分销通知', 'commission', NULL, NULL, NULL, NULL, 0, 'commission', '分销消息通知'),
...
CREATE TABLE IF NOT EXISTS `ims_ewei_shop_order` (
  ...
  `is_cashier` tinyint(3) DEFAULT '0',
  `commissionmoney` decimal(10,2) DEFAULT '0.00',
...
(3, 3, 'commission', 'biz', '微商宝分销', '1.0', '官方', 1, '../addons/ewei_shopv2/static/images/commission.jpg', '', 0, 0, 0),
...
(18, 19, 'groups', 'biz', '微商宝拼团', '1.0', '官方', 1, '../addons/ewei_shopv2/static/images/groups.jpg', '', 0, 0, 0),
